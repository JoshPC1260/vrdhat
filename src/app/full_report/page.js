...
export default function FullReport() {
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const response = await fetch('http://54.221.79.123/api/fetch-data');
        ...
        <div>
            ...
            <section id="page1">
                <div className="page1-text">
                    <h1>Did you know there are <span id="monthly-users">{last_month_searches} monthly</span> Google searches for “churches near me” in <span id="location">{loc_city}, {loc_state}</span>?</h1>
                </div>
            ...
            <section id="page2">
                ...
                <div className="containers">
                    <div className="ct1">
                        ...
                        <br />
                        <h1 className="ct1-title">What Is <span id="title-ch-ct1">Voice Search</span> & Why It’s Important</h1>
                        <br />
                        <p className="ct1-p">Voice technology allows people to perform a hands-free search by asking questions to their smart
                            devices such as smartphones, smart speakers, and in-car systems. Your church’s Digital Voice Score shows how optimized
                            your digital presence is when it comes to showing up in voice search results.</p>
                    </div>
                    <div className="ct2">
                        <h1 className="ct2-title">57%</h1>
                        <p className="ct2-p">of American adults use voice assistants on their devices to find out information on a daily basis.</p>
                    </div>
                    <div className="ct3">
                        ...
                        <br />
                        <p className="ct3-p">are optimized for voice search. If your church’s digital presence isn’t optimized for voice search, people won’t be able to find and visit your church!</p>
                        <br />
                        <a className="ct3-a" href="#">Source: VisitorReach</a>
                    </div>
                </div>
            </section>
            ...
            <section id="page3">
                ...
                <div className="containers-pg3">
                    ...
                    <div className="ct1-pg3">
                        <h1 className="ct1-title">People in the U.S. search for “churches near me” over <span id="title-ch-ct1">1 million</span> times each month</h1>
                    </div>

                    <div className="ct2-pg3">
                        <h1 className="ct1-title">Nearly <span id="title-ch-ct1">2 billion</span> people use Google Maps every month</h1>
                        <p className="ct1-p"></p>
                    </div>
            
                    <div className="ct3-pg3">
                        <img src="img-ct3-page3.png" />
                        <h1 className="ct3-title">What is your <span id="title-ch-ct1">Digital Maps</span> Score & Why it’s Important</h1>
                        <p className="ct3-p">From where we eat to where we visit, digital maps are more important in our lives than ever before. The Digital Maps Score reflects how likely your church is to show up on these digital navigation apps when someone searches for “churches near me,” If your church information isn’t listed correctly, they won’t find you.</p>
                    </div>
                ...
                <div className="containers-pg4">
                    ...
                    <div className="ct1-pg4">
                        <h1 className="ct1-title-pg4">
                            Americans average <span id="title-ch-ct1">17.5 hours a week</span> on social media— <span id="title-ch-ct1">six</span> times more than they spend in church.</h1>
                    </div>

                    <div className="ct2-pg4">
                        <img src="img-ct2-page4.png" />
                        <br />
                        <h1 className="ct1-title">What is your <span id="title-ch-ct1">Social Clarity</span> Score & Why does it Matter</h1>
                        <br />
                        <p className="ct1-p">Your Social Clarity Score reviews your church’s social information and validates whether your content is listed correctly and aligns with major directories. VisitorReach specializes in perfecting your social clarity score to maximize your digital reach through personalized marketing campaigns.</p>
                    </div>
            ...
            <section id="page5">
                ...
                <div className="containers-pg5">
                    ...
                    <div className="ct1-pg5">
                        ...
                        Why your <span id="title-ch-ct1">Website Authority Score</span> is Important</h1>
                        <br />
                        <p className="ct1-p">The #1 organic result is 10x more likely to receive a click compared to #10 spot. This makes having a well-ranking website extremely important. A strong online presence leads to more people finding your church, identifying with your mission and culture, and visiting your church.</p>
                    </div>

                    <div className="ct2-pg5">
                        <h1 className="ct2-title-pg5">9 out of 10 people will visit your church website before ever visiting in-person</h1>
                    </div>
                    ...
                    <div className="ct4-pg5">
                        <div className="ct4-pg5-text-img">
                            <div className="ct4-pg5-text">
                                ...
                                <p className="ct3-p">The top 8 keywords or phrases your website is known for by Google and other search engines</p>
                            </div>
            ...
            <section id="page6">
                ...
                <div className="containers-pg6">
                    ...
                    <div className="ct2-pg6">
                        <p className="ct2-p-pg6">What can your church do to improve your digital outreach strategy to engage those who are lost, hurting, and seeking the truth of the gospel message?</p>
                    </div>
                    <div className="ct3-pg6">
                        ...
                        <br />
                        <p className="ct3-p">If you’re surprised by your digital health score, you are not alone. Most churches are in the same boat.</p>
                        <br />
                        <img src="img-ct4-page6.png" alt="" />
                        <br />
                        <h2 className="ct3-title2">79% of churches</h2>
                        <br />
                        <p className="ct3-p">feel they don’t “have a well-defined digital ministry” for engaging nonbelievers or people outside their church community.</p>
                    </div>
                </div>
            </section>
            ...
            <section id="page7">
                ...
                <div className="ct-pg7-title-text">
                    <br />
                    <h1 className="ct1-title-pg7"><span id="title-ch-ct1">VisitorReach™</span>—Your Digital Outreach Platform</h1>
                    <br />
                    <p>VisitorReach is much more than just a website optimization platform or advertising agency. It’s a digital outreach program empowering pastors to have continual and consistent 1:1 SMS <span id="title-ch-ct1">conversations with seekers and new people to your city.</span> Churches that partner with VisitorReach average 40–160 new conversations every month and see new visitors walking through their doors every week.</p>
                    <br />
                    <div className="containers-pg7">
                        <div className="ct1-pg7">
                            <img src="img-ct1-page7.png" alt="" />
                            <br />
                            <p className="ct1-p">"We had new people responding within hours, and we had people showing up to youth and weekend service within one week."</p>
                            <br />
                        ...
                        <div className="ct2-pg7">
                            ...
                            <br />
                            <p className="ct1-p">"Our team loves the simplicity of the VisitorReach platform. It is so easy to use the app, and the aiChurchTech assistance makes it so easy to stay up-to-date with all our new visitors."</p>
                            <br />
                            <p>—Jesus Culture, Sacramento, CA</p>
                        </div>
                    </div>
                    <br />
                    <h1 className="ct1-title-text-below">The VisitorReach Process - <br /><span id="title-ch-ct1">Created for Pastors, by Pastors</span></h1>
